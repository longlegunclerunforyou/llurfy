...
$sql="INSERT job(postername,posterid,topic,location,reward,description,starttime,deadline,receiveid,receivename,pic)
      Values('$postname','$fb_id','$topic','$location','$reward','$des','$st','$ft','$id','$name','$pic')";
mysql_query($sql);
