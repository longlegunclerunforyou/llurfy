                            ...
                            <div class="panel-body">
                              <div><!--裡面內容-->
                                ...
                                <div class="tab-content">
                                  ...
                                  <div class="tab-pane" id="profile">&nbsp;&nbsp;&nbsp;&nbsp;<h3>&nbsp;&nbsp;&nbsp;&nbsp;SNA課程學習到多種的架設網站的工具，從基礎的HTML到CSS、PHP，而後進展的FB API，甚至是版本開發工具都是之前尚未有所接觸的，因此以學習的種種作為開發本網站的基礎，當中遇上不少困難，多是觀念不清加上從未接觸所造成的，但與隊友的合作中學習到不少知識與合作感想，即便目前公立尚且不成熟，但依然是寶貴的經驗。</h3></div>
