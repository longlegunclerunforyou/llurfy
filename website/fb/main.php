                ...
                <div class="modal-content">
                      <form name="form1" method="post" action="addpost.php">
                          ...
                          <div class="modal-body">
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon">Topic</span>              
                                    <input type="text" class="form-control" value="please decribe the job you'll post in one sentence" name="in_topic" disabled> 
                                </div>
                                <br>

                                <div class="input-group">
                                  <span class="input-group-addon">Locations</span>
                                  <input type="text" class="form-control" value="where to work , if there're more places need to go. pls type them all." name="in_location" disabled>
                                </div>
                                <br>                           

                                <div class="input-group">
                                  <span class="input-group-addon">Reward</span>
                                  <input type="text" class="form-control" value="Money , something or nothing" name="in_reward" disabled>
                                </div>
                              
                                <div class = "row">
                                  <div class="col-lg-6">
                                    <h4><span class="label label-default">Start Time</span></h4>
                                    <input type="text" value="2014/03/15 05:06" id="datetimepicker" name="in_st" disabled><br>
                                  </div>

                                  <div class="col-lg-6">
                                    <h4><span class="label label-default">Finish Time</span></h4>
                                    <input type="text" value="2015/06/20 07:08" id="datetimepicker2" name="in_ft" disabled><br>                        
                                  </div>
                                </div>
                                <br>
           
                                <textarea class="form-control text" rows="15" style="resize: none;" placeholder="give some more details about your job ...." name="in_des" disabled></textarea>                                
                          </div><!--modal body-->
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                          <button type="submit" class="btn btn-primary" value="Post!!">I want it !!</button>
                        </div>
