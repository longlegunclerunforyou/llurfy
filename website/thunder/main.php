            ...
            window.fbLoaded = function () {
                ...
                $('#fb-share').click(function(){
                        ...
                        FB.ui(
                        {
                            ...
                            method: 'feed',
                            name: '我在長腿叔叔網站上發布一則『'+jtopic+'』的臨時工作，趕快來賺點外快吧！',
            ...
            <div class="panel panel-info">                          
                  ...
                  <div class='media'>
                      ...
                      <div class='media-body'>
                        <div class='pull-left'>
                          ...
                          <a href='https://www.facebook.com/llurfy' target='_blank' ><button class='btn btn-info'>FB offical website</button></a>
                        </div> 
              ...
              ?>
                  ...
                  <?php              
                      ...
                      echo "</ul>";
                      echo "<div style='float:right; '><h4>尚有".$total."筆工作可以接收</h4></div>";
