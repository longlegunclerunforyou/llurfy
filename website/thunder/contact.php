...
<html lang="en">
  ...
  <body>
                    ...
                    <div class='media'>
                        ...
                        <div class='media-body'>
                          ...
                          <div class='pull-right' style='WIDTH: 130px;'>
                            ...
                            <a href='posted.php'><button type='button' class='btn btn-info btn-lg ' style='WIDTH: 130px;'>My Received</button></a>
                          </div>
                        ...
                        <div class="panel panel-success">
                          ...
                          <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body">
                              ...
                              <div class="col-3"><a href="#" id="example" class="btn btn-success" rel="popover" data-content="ppitjine@hotmail.com" data-original-title="偉甯's Email">偉甯's Email</a></div>
                              <div class="col-3"><a href="#" id="example2" class="btn btn-success" rel="popover" data-content="rest950@gmail.com" data-original-title="明宏's Email">明宏's Email</a></div>
                              <div class="col-3"><a href="#" id="example3" class="btn btn-success" rel="popover" data-content="tornadowind99@gmail.com" data-original-title="家瑞's Email">家瑞's Email</a></div>
                              </div>
                          </div>
                        </div>
                      </div>                  
    ...
    <script>
      $(function (){
         $("#example2").popover(top);
      });
    </script>

    <script>
      $(function (){
         $("#example3").popover(top);
      });
    </script>
